...
NOTE: This algorithm works also on normal 2D videos, just by adjusting the parameters back to pixel information and using the video as an input to traslate the frames to Mat instead of the pointcloud and ROS functions.
