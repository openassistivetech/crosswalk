...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'multisense_cal_check' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/drc/catkin_ws/src/multisense-3.1/multisense_cal_check/${idir}'.  Ask the maintainer 'Carnegie Robotics <support@carnegierobotics.com>' to fix it.")
    endif()
